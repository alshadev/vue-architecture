 ...
 * 
 * This file contains all SVG icons used in the application.
 * To switch to an icon library (Heroicons, Lucide, etc.), 
 * simply modify this file - no changes needed in components.
 * 
 * All icons use currentColor for stroke/fill, so they inherit text color.
 */
